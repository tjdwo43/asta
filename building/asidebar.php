    ...
    <div class="aside-inner">
        <nav class="sidebar" data-sidebar-anyclick-close="">
            ...
            <div class="sidebar-title">
                ...
                <button type="button" class="btn btn-info pt-0 pb-0" onclick="getBuidlingListView()">조회</button>
            </div>
            <ul class="sidebar-nav">
                <div class="table-responsive">
                    <table id="bIdgList" class="table">
                        <colgroup>
                            <col width="50px"/>
                            <col width="60px"/>
                            <col width="*"/>
                        ...
                        <tr>
                            ...
                            <th class="font-weight-normal listSortBtn" onclick="sortTable(1, 'bIdgList')"><span class="mr-2">NO</span> <i class="fas fa-sort-up"></i></th>
                            <th class="font-weight-normal listSortBtn" onclick="sortTable(2, 'bIdgList')">건물명 <i class="fas fa-sort-up"></i></th>
                        </tr>
                        </thead>
                        <tbody>
