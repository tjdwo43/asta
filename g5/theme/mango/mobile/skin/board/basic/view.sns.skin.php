...
<?php } ?>
<button type="button" class="btn btn_b01 share_btn"><i class="fa fa-share-alt"></i> 공유</button>
...
<div id="bo_v_sns">
    ...
    <div class="sns_wr">
        ...
        <button type="button" class="btn_close" title="닫기"><i class="fa fa-times"></i></button>
    </div>
</div>   
...
<script>
    $(function(){
        $(".share_btn").click(function(){
         ...
         $("#bo_v_sns .btn_close,#bo_v_sns .bg").click(function(){
            $("#bo_v_sns").hide();
        });
